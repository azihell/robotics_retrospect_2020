...
% Informações gerais
    ...
    \thesisauthor{Aziel Martins de Freitas Júnior}
...
% Deactivate page numbering since the appendices are already numbered
...
% Include thesis appendices
    \begin{thesisappendices}
        ...
        \includepdf[pages={-}]{Appendices/A-RAJA.pdf}

        \chapter{Manipulador robótico ``El Borgson''}
        \label{app:elborgson}
        \includepdf[pages={-}]{Appendices/B-elborgson.pdf}

        \chapter{Corrida de revezamento: DARwIn-OP}
        \label{app:darwin}
        \includepdf[pages={-}]{Appendices/C-RAJA-stats2.pdf}

        \chapter{Projeto de experimento}
        \label{app:doe}
        \includepdf[pages={-}]{Appendices/D-doe.pdf}

        \chapter{UGV CUCA}
        \label{app:cuca}
        \includepdf[pages={-}]{Appendices/E-orbslam.pdf}

        \chapter{Artigo do manipulador RAJA - V SAPCT}
        \label{app:rajapaper}
        \includepdf[pages={-}]{Appendices/F-artigoRAJA.pdf}

        \chapter{V SAPCT - certificado de participação }
        \label{app:sapctpart}
        \includepdf[pages={-}]{Appendices/cert-part-V-SAPCT.pdf}

        \chapter{V SAPCT - certificado do resumo expandido }
        \label{app:sapctresumo}
        \includepdf[pages={-}]{Appendices/cert-resumo-V-SAPCT.pdf}

        \chapter{Projeto TRIS - Artigo SIINTEC}
        \label{app:trispaper}
        \includepdf[pages={-}]{Appendices/G-artigoTRIS.pdf}
        
        \chapter{Projeto TRIS: Certificado de participação SIINTEC}
        \label{app:certif}
        \includepdf[pages={-}, scale=0.9]{Appendices/G-certificado.pdf}
