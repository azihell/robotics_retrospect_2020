...
% Deactivate page numbering since the appendices are numbered
...
% Include thesis appendices
    \begin{thesisappendices}
        ...
        % \includepdf[pages={1-66}, pagecommand={}]{Appendices/A-RAJA.pdf}

        \chapter{Manipulador robótico ``El Borgson''}
        \label{app:elborgson}
        % \includepdf[pages={1-161}, pagecommand={}]{Appendices/B-elborgson.pdf}

        \chapter{Corrida de revezamento: DARwIn-OP}
        \label{app:darwin}
        % \includepdf[pages={-}, pagecommand={}]{Appendices/C-RAJA-stats2.pdf}

        \chapter{Projeto de experimento}
        \label{app:doe}
        % \includepdf[pages={-}, pagecommand={}]{Appendices/D-doe.pdf}

        \chapter{UGV CUCA}
        \label{app:cuca}
        % \includepdf[pages={-}, pagecommand={}]{Appendices/E-orbslam.pdf}

        \chapter{Manipulador RAJA - Artigo SAPCT}
        \label{app:rajapaper}
        % \includepdf[pages={-}, pagecommand={}]{Appendices/F-artigoRAJA.pdf}

        \chapter{Projeto TRIS - Artigo SIINTEC}
        \label{app:trispaper}
        % \includepdf[pages={-}, pagecommand={}]{Appendices/G-artigoTRIS.pdf}
        
        \chapter{Projeto TRIS: Certificado de participação SIINTEC}
        \label{app:certif}
        \includepdf[pages={-}, scale=0.85]{Appendices/G-certificado.pdf}
